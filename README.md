...
| **[review-changes](skills/review-changes/SKILL.md)** | Perform evidence-based static review across Git revisions, working trees, folders, patches, or artifact versions before human review or acceptance. |
...
Install these through the Claude Code skill system or link them into the Claude Code skills directory. `review-changes` also follows the portable Agent Skills format and can be installed through another harness's skill-discovery mechanism.
