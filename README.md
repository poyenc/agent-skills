...
| Skill | Description |
|-------|-------------|
| **[hip-ref](skills/hip-ref/SKILL.md)** | AMD HIP GPU kernel developer reference for CDNA3 and CDNA4 architectures. Covers MFMA instructions, register layout, LDS, occupancy, profiling, and more. |
