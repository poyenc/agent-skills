...
| **[monorepo-bridge](skills/monorepo-bridge/)** | Bidirectional commit transfer between monorepos and standalone submodule repos. CLI tool with setup, split, pick, export, and sync subcommands. Auto-detects config from existing remotes. |
