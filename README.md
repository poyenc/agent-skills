...
| **[deep-review](skills/deep-review/SKILL.md)** | Thorough code review of PRs or local branches. Reads full files (not just diffs), spawns scoped subagents for issue discovery (correctness, design, performance), validates findings, and produces inline comment drafts. Supports summary, walkthrough, and review modes. |
